...
auth.settings.extra_fields['auth_user']= [
  ...
  Field('myblob','blob',requires = IS_NOT_EMPTY()),
  Field('DOB','date',requires=IS_NOT_EMPTY(),default=date(request.now.year-18,request.now.month,request.now.day)),
  Field('age', 'integer',writable=False),
  Field('height','integer',requires = IS_NOT_EMPTY()),
  Field('salary', requires = IS_IN_SET(['0-10,000', '10,000-25,000', '25,000-50,000', '50,000-200,000', '200,000+'])),
  Field('employment', requires = IS_IN_SET(['Government', 'Private', 'Self-Employed', 'Unemployed'])),
...
db.define_table('find',
                ...
                Field('minimum_salary',requires = IS_IN_SET(['0','10,000','25,000','50,000','200,000'])))
